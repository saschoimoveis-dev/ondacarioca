...
export function CtaLink({
  ...
  const baseClassName =
    variant === "primary"
      ? `btn-primary-premium${pulse ? " btn-pulse" : ""} group inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 text-[15px] font-bold transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_12px_32px_rgba(23,63,52,0.4)] active:scale-[0.98]`
