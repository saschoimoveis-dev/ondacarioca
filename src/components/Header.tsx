    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/92 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/lancamentos" className="flex items-center gap-3">
          <span className="grid size-10 place-items-center rounded-sm border border-emerald-900 bg-emerald-950 text-sm font-semibold text-white">
            OC
          </span>
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-slate-700 md:flex">
          <Link href="/lancamentos" className="transition hover:text-emerald-800">
            Lancamentos
          </Link>
          <a href="#atendimento" className="transition hover:text-emerald-800">
            Atendimento
          </a>
        ...
        <a
          href={whatsappHref}
          className="inline-flex items-center gap-2 rounded-sm bg-emerald-700 px-3 py-2 text-sm font-semibold text-white transition hover:bg-emerald-800"
        >
